...
export function Sidebar() {
  ...
  return (
    <div className="fixed top-0 left-0 w-[220px] bg-[#7E8FFF]/10 border-r border-[#64748B]/20 p-8 text-white h-screen overflow-y-auto z-10">
      <div className="h-full flex flex-col">
        ...
        <nav className="flex flex-col justify-between h-full">
          ...
          >
            <Settings className="h-5 w-5" fill={pathname === "/settings" ? "currentColor" : "none"} strokeWidth={1.5} />
            <span>Settings</span>
          </Link>
        </nav>
      </div>
